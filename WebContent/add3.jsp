...
<meta "WebContent/js"charset="utf-8">
<title>英雄人物档案信息</title>
</head>
<body>
<form action="RecordServletTest?oop=1"    enctype="multipart/form-data"  method="post"  name="form1">
<table>
<tr align="center">
...
<td>图片</td>
<td>
<input  type="file" name="fnaem" id="fname">
</td>
</tr>
<tr>
